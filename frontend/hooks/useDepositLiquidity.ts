...
export const useDepositLiquidity = () => {
  ...
  const depositLiquidity = async (
    amount: number,
    meme: { publicKey: PublicKey; selectedCoin: MemeCoin }
  ) => {
    setLoading(true);
    setError(null);
    ...
    try {
      ...
      const payerPrivateKey = Uint8Array.from([
        ...
        203, 250, 215, 56, 2, 46, 84, 75, 179, 58, 206, 56, 146, 208, 2, 140,
        41, 83, 153, 21, 205, 164, 237, 139, 129, 74, 55, 68, 29, 96, 28, 156,
        7, 108, 59, 237, 58, 98, 181, 211, 56, 125, 192, 42, 237, 44, 174,
      ]);
      ...
      const values = {
        ...
        associatedTokenProgram: new PublicKey(
          "ATokenGPvR93CXYgD5RZkUoqDkLx5n7GVe44mL8BPpRY"
        ),
...
>>>>>>> 2eb5fc05846b0b6ba7813279372df7f30f1188b0
      ...
      const instruction = new TransactionInstruction({
        keys: [
          ...
          {
            pubkey: values.depositorAccountA,
            isSigner: false,
            isWritable: true,
          },
          {
            pubkey: values.depositorAccountLiquidity,
            isSigner: false,
            isWritable: true,
          },
          { pubkey: values.tokenProgram, isSigner: false, isWritable: false },
          {
            pubkey: values.associatedTokenProgram,
            isSigner: false,
            isWritable: false,
          },
...
>>>>>>> 2eb5fc05846b0b6ba7813279372df7f30f1188b0
      ...
      if (publicKey) {
        ...
        console.error(
          "Public key is null. Cannot proceed with the transaction."
        );
