        ...
        return (
          <div className="flex space-x-2">
            <button className="rounded" disabled={!isActive} onClick={onAttack}>
              <Image src="/assets/battle-layout/skills/Frame 6.png" width={100} height={100} alt="Habilidad 1" />
            </button>
            <button className="rounded" disabled={!isActive} onClick={onAttack}>
              <Image src="/assets/battle-layout/skills/Frame 11.png" width={100} height={100} alt="Habilidad 2" />
            </button>
            <button className="rounded" disabled={!isActive} onClick={onAttack}>
              <Image src="/assets/battle-layout/skills/Frame 12.png" width={100} height={100} alt="Habilidad 3" />
            </button>
          </div>
        );
      case 'team':
