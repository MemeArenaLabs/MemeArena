      ...
      <div className="flex flex-grow">
        <div className="pt-2 pl-2 ">
          ...
          <div className="flex justify-center items-center h-full w-[500px] ">
            <div>
              <div className="flex gap-2  w-[400px] overflow-x-scroll overflow-y-hidden pb-4  ">
                <div className="w-32 h-[110px] relative group cursor-pointer">
                  ...
                  <div className="w-32  h-full">
                    ...
                    <div className="w-32 flex items-center justify-center h-[27px] bg-[#05345A] bg-opacity-70">
              ...
              <div className="pt-2">
                <button className="bg-yellow text-black font-bold text-[14px] h-10 w-[367px] flex items-center justify-center gap-1">
