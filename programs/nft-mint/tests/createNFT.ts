...
(async () => {
  ...
  const metadata = {
    ...
    symbol: "GLADIATOR",
    description:
      "The WIF is a legendary gladiator type Plant and Rogue",
    image:
      "https://bafybeic75qqhfytc6xxoze2lo5af2lfhmo2kh4mhirelni2wota633dgqu.ipfs.nftstorage.link/", //It's a ship, we have to update the image
  };
