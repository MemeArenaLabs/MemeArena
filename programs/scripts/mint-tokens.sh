...
spl-token mint $TOKEN_ADDRESS_WIF 300000 $TOKEN_ACCOUNT_WIF
...
RECIPIENT_ADDRESS_RAQUEL="AS8dNZvz12LH8vzGeyAtwPdRiAwj1epGas3C9BpnGGj7"
RECIPIENT_ADDRESS_LUCHO="7dY73Q3mbHj5VuDKnGXdWfu1Trpt1Nn9MmZ8ZdiM3nM5"

spl-token transfer $TOKEN_ADDRESS_WIF 100000 $RECIPIENT_ADDRESS_FRANCO --from $TOKEN_ACCOUNT_WIF --fund-recipient
spl-token transfer $TOKEN_ADDRESS_WIF 100000 $RECIPIENT_ADDRESS_RAQUEL --from $TOKEN_ACCOUNT_WIF --fund-recipient
spl-token transfer $TOKEN_ADDRESS_WIF 100000 $RECIPIENT_ADDRESS_LUCHO --from $TOKEN_ACCOUNT_WIF --fund-recipient
...
spl-token mint $TOKEN_ADDRESS_BONK 30000000 $TOKEN_ACCOUNT_BONK
...
spl-token transfer $TOKEN_ADDRESS_BONK 10000000 $RECIPIENT_ADDRESS_LUCHO --from $TOKEN_ACCOUNT_BONK --fund-recipient
...
spl-token mint $TOKEN_ADDRESS_MOO 30000000 $TOKEN_ACCOUNT_MOO
...
spl-token transfer $TOKEN_ADDRESS_MOO 10000000 $RECIPIENT_ADDRESS_LUCHO --from $TOKEN_ACCOUNT_MOO --fund-recipient
...
spl-token mint $TOKEN_ADDRESS_POP 30000000 $TOKEN_ACCOUNT_POP
...
spl-token transfer $TOKEN_ADDRESS_POP 10000000 $RECIPIENT_ADDRESS_LUCHO --from $TOKEN_ACCOUNT_POP --fund-recipient
...
spl-token mint $TOKEN_ADDRESS_GIGA 300000000 $TOKEN_ACCOUNT_GIGA

spl-token transfer $TOKEN_ADDRESS_GIGA 100000000 $RECIPIENT_ADDRESS_FRANCO --from $TOKEN_ACCOUNT_GIGA --fund-recipient
spl-token transfer $TOKEN_ADDRESS_GIGA 100000000 $RECIPIENT_ADDRESS_RAQUEL --from $TOKEN_ACCOUNT_GIGA --fund-recipient
spl-token transfer $TOKEN_ADDRESS_GIGA 100000000 $RECIPIENT_ADDRESS_LUCHO --from $TOKEN_ACCOUNT_GIGA --fund-recipient
